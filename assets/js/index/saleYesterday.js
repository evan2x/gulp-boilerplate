...
exports.load = function(cb){
  ...
  var saleYesterdayPager = new Pagination({
    el: $('#yesterdayPagination'),
    page: initialData.page,
    pageSize: initialData.pageSize,
    total: initialData.total
  });

  var saleYesterdayTable = new Table({
    el: $('#yesterdayTable'),
  ...
  store.subscribe(function(payload){
    ...
    .then(function(data){
      ...
      saleYesterdayPager.setPage(page.pageNum);
      saleYesterdayPager.setPageSize(page.pageSize);
      saleYesterdayPager.setTotal(page.totalCount);

      saleYesterdayTable.render(data.list);
      $.isFunction(cb) && cb();
    });
  });  

  saleYesterdayTable.on('sort', function(data){
    actions.tableSort(data);
  });

  saleYesterdayPager.on('change', function(data){
